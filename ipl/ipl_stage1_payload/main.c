...
#define ERASE_RAM_START 0
#define RESET_VECTOR_ADDRESS 0
#define PRE_STAGE2_ADDR 0
#define ROM_HMAC_ADDRESS 0

#define STAGE2_PATCH_INJECTION_ADDRESS 0
#define CLEAR_STRACHPAD_ADDRESS 0
#define ENTRY_POINT_ADDRESS 0
#define SET_SEED_ADDRESS 0
...
#elif IPL_05G || IPL_07G || IPL_09G || IPL_11G
	// TODO!
#endif
};
...
#elif IPL_04G || IPL_05G || IPL_07G || IPL_09G || IPL_11G
